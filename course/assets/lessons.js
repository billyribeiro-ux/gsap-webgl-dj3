/* ============================================================================
   ...
   `status: "soon"`  = scaffolded, expandable in a later pass.
   ============================================================================ */
window.COURSE = {
  title: "MOTION",
  ...
  modules: [
    {
      ...
      lessons: [
        ...
        { slug: "02-easing-and-timing", title: "Easing & Timing — The Soul of Motion", status: "soon" },
        { slug: "03-performance-and-a11y", title: "60fps & Accessible Motion", status: "soon" }
      ]
    },
    {
      num: "M1",
    ...
    },
    {
      ...
      lessons: [
        ...
        { slug: "21-phosphor-icons", title: "Building a Living Phosphor Icon System", status: "soon" },
        { slug: "22-svg-morphing", title: "Shape Morphing", status: "soon" }
      ]
    },
    {
      num: "M3",
    ...
    },
    {
      ...
      lessons: [
        ...
        { slug: "41-stagger", title: "Stagger — Choreographing Many Elements", status: "soon" },
        { slug: "42-gsap-utils", title: "gsap.utils — The Secret Toolbox", status: "soon" }
      ]
    },
    {
      num: "M5",
      ...
      lessons: [
        ...
        { slug: "51-nested-timelines", title: "Nested & Reusable Timelines", status: "soon" }
      ]
    },
    {
      num: "M6",
      ...
      lessons: [
        ...
        { slug: "61-horizontal-scroll", title: "Horizontal Scroll Storytelling", status: "soon" }
      ]
    },
    {
      num: "M7",
      ...
      lessons: [
        ...
        { slug: "71-motionpath", title: "MotionPath & DrawSVG", status: "soon" }
      ]
    },
    {
      num: "M8",
      ...
      lessons: [
        ...
        { slug: "81-d3-force", title: "Force-Directed Motion", status: "soon" }
      ]
    },
    {
      num: "M9",
      ...
      lessons: [
        ...
        { slug: "91-shaders", title: "A Gentle Introduction to Shaders", status: "soon" }
      ]
    },
    {
      num: "M10",
      ...
      lessons: [
        ...
        { slug: "a1-threlte-scroll", title: "Scroll-Linked & GSAP-Driven 3D", status: "soon" }
      ]
    },
    {
      num: "M11",
      ...
      lessons: [
        ...
        { slug: "b1-apple-reveal", title: "An Apple-Style Product Reveal", status: "soon" },
        { slug: "b2-title-sequence", title: "A Hollywood Title Sequence", status: "soon" }
      ]
    }
  ]
};
